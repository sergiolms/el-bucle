...
export const TAB_BASE_CLASSES = "font-mono text-sm sm:text-base uppercase border border-white/5 hover:bg-white/5 transition-all duration-300 py-3 px-3 sm:px-5 rounded-none flex items-center justify-center gap-2.5 whitespace-nowrap backdrop-blur-md flex-shrink-0 flex-1"
...
export function getTabClasses(color: 'pink' | 'cyan' | 'orange' | 'yellow', position: 'first' | 'middle' | 'last') {
  const colorClasses = {
    pink: {
      ...
      default: "text-retro-pink/70 hover:border-retro-pink/20 hover:text-retro-pink/90 bg-transparent"
    },
    cyan: {
      ...
      default: "text-retro-cyan/70 hover:border-retro-cyan/20 hover:text-retro-cyan/90 bg-transparent"
    },
    orange: {
      ...
      default: "text-retro-orange/70 hover:border-retro-orange/20 hover:text-retro-orange/90 bg-transparent"
    },
    yellow: {
